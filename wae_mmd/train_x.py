...
parser.add_argument('--model', type=str, default='../model/model.tar', help='model address')
parser.add_argument('--train_root', type=str, default='/home/zww/cv/defect/data/train', help='train data address')
parser.add_argument('--test_root1', type=str, default='../raw_data/round_test/part1/TC_Images', help='test data address part 1')
parser.add_argument('--test_root2', type=str, default='../raw_data/round_test/part2/TC_Images', help='test data address part 2')
parser.add_argument('--temp_data', type=str, default='../temp_data/', help='test data address part 2')
...
parser.add_argument("--json_part1",type=str,default='../temp_data/result/data/focusight1_round1_train_part1/TC_Images')
parser.add_argument("--json_part2",type=str,default='../temp_data/result/data/focusight1_round1_train_part2/TC_Images')
