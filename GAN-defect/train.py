...
class Config(object):
    data_path = r'/home/lyl/object Detection/data/OK_Images/'
    val_path = r'/home/lyl/object Detection/data/TC_images/'
    save_path = '/home/lyl/object Detection/GAN-defect/data/0616'
    work_dir = '/home/lyl/object Detection/GAN-defect/data/0616'
    val_save_path = '/home/lyl/object Detection/GAN-defect/data/0616-val'
    ...
    s_start = 0
    decay_every = 10
    # netd_path = '/data/focusight1_round1_train_part1/d_ckpt_e2000.pth'
    # netg_path = '/data/focusight1_round1_train_part1/g_ckpt_e2000.pth'
    netd_path = None
    netg_path = None
    # nets_path=None
    mean = (0.5, 0.5, 0.5)
...
def train(opt):
    ...
    #torch.load(opt.netg_path, map_location=map_location)['net'] 可以将参数加载到CPU上
    ...
    # if opt.nets_path:
    #     print('loading checkpoint for segmentation...')
    #     checkpoint=modify_checkpoint(nets,torch.load(opt.nets_path,map_location=map_location)['net'])
